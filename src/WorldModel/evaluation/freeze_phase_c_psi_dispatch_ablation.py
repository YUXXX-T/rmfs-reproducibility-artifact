"""Freeze inputs and source hashes for the 551--560 psi-dispatch ablation."""
...
BUNDLE_NAME = "phase_c_psi_dispatch_frozen_protocol.json"
...
def freeze(output_root: Path = OUTPUT_ROOT) -> Path:
    artifacts: dict[str, Mapping[str, Any]] = {
        ...
        "psi_head_checkpoint": _artifact(PSI_HEAD_CHECKPOINT),
        "psi_scale_contract": _artifact(PSI_SCALE_CONTRACT),
    }
    ...
    manifest_rows.append(f"{sha256_file(bundle_path)}  {bundle_path.as_posix()}")
    _atomic_write(
