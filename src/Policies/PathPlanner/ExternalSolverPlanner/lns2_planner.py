...
LNS2 Planner
=============
Wrapper for the MAPF-LNS2 C++ solver.

Reference: Li et al. (2022). "MAPF-LNS2: Fast Repairing for
Multi-Agent Path Finding via Large Neighborhood Search." AAAI-22.
"""
...
_DEFAULT_BINARY = os.path.join(_SOLVER_DIR, "MAPF-LNS2", "build", "lns")

_COORD_RE = re.compile(r"\((\d+),(\d+)\)")


class LNS2Planner(BaseExternalSolverPlanner):
